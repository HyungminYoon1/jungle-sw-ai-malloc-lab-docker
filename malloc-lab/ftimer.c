...
/*
 * ftimer_itimer - 인터벌 타이머를 사용해 f(argp)의 실행 시간을 추정
 *                 n회 실행 평균을 반환
 */
...
/*
 * ftimer_gettod - gettimeofday를 사용해 f(argp)의 실행 시간을 추정
 *                 n회 실행 평균을 반환
 */
