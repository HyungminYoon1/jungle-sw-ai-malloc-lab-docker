# 📘 Docker + VSCode DevContainer 기반 Malloc Lab 개발 환경 가이드
...
│
├── DOCKER_DEVCONTAINER_GUIDE.md  # 개발 환경 설정 가이드
└── README.md                     # 프로젝트 소개 및 과제 안내
```
...
이제 본격적으로 문제를 풀 시간입니다. `README.md`와 `malloc-lab/README.md`를 참고해서 Malloc Lab 과제를 진행해 보세요.
